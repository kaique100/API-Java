...
public class TipoUsuarioUpdate {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		objTipoUsuario.setIdTipoUsuario(id("Digite o ID Tipo Usuario a ser atualizado: "));
		objTipoUsuario.setNivelAcesso(texto("Digite o Nivel de Acesso: "));
		
		System.out.println(dao.atualizar(objTipoUsuario));
