...
public class OrdemServicoUpdate {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException, ParseException {
		...
		objOrdemServico.setIdOrdemServico(id("Digite o ID da Ordem Serviço a ser atualizado: "));
		...
		System.out.println(dao.atualizar(objOrdemServico));
