...
public class GuinchoPrestadorServicoUpdate {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		objGuinchoPrestadorServico.setIdGuinchoPrestadorServico(id("Digite o ID do Guincho Prestador Serviço a ser atualizado: "));
		...
		System.out.println(dao.atualizar(objGuinchoPrestadorServico));
